  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-white opacity-20 blur-2xl pointer-events-none"></div>
        {/* <motion.div
          initial={{ width: "8rem" }}
        ...
        ></motion.div> */}
        {/* Garis putih di atas dihapus agar hanya siluet cahaya lampu yang tersisa */}
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-transparent "></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/4 z-50 flex flex-col items-center px-5">
          {children}
        </div>
      </div>
    </div>
